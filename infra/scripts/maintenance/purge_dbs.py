...
Usage:
  python3 infrastructure/maintenance/purge_dbs.py
  python3 infrastructure/maintenance/purge_dbs.py --confirm
  python3 infrastructure/maintenance/purge_dbs.py --drop-recreate-db  # Drop and recreate database (requires migrations after)
  python3 infrastructure/maintenance/purge_dbs.py --database-url postgresql://... --redis-url redis://...
"""
