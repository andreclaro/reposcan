...
|------------------|-------------------|------------|
| `src/db/schema/plans.ts` | `webapp/src/db/schema.ts` | Simplify for single provider (Stripe) |
| `src/db/schema/credits.ts` | `webapp/src/db/schema.ts` | Rename to usage_records for scans |
| `src/lib/stripe/index.ts` | `webapp/src/lib/stripe/index.ts` | Direct copy |
| `src/lib/stripe/StripeWebhookHandler.ts` | `webapp/src/lib/stripe/webhook-handler.ts` | Remove credit purchase logic |
| `src/lib/credits/recalculate.ts` | `webapp/src/lib/usage.ts` | Adapt for scan counting |
| `src/app/super-admin/plans/` | `webapp/src/app/app/admin/plans/` | Simplify admin UI |
